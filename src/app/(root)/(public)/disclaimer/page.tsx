const Disclaimer = () => {
  return (
    <div className="pt-20 min-h-screen">
      <h1 className="text-3xl font-bold">Disclaimer for HotTopicsHub</h1>
      <p className="text-xl mt-5">
        If you require any more information or have any questions about our
        site's disclaimer, please feel free to contact us by email at
        hot-topics@email.com
      </p>

      <h1 className="text-3xl font-bold mt-8">Disclaimers for HotTopicsHub</h1>
      <p className="text-xl mt-5">
        All the information on this website - https://hot-topics.vercel.app/ -
        is published in good faith and for general information purpose only.
        HotTopicsHub does not make any warranties about the completeness,
        reliability and accuracy of this information. Any action you take upon
        the information you find on this website (HotTopicsHub), is strictly at
        your own risk. HotTopicsHub will not be liable for any losses and/or
      ...
      <h1 className="text-3xl font-bold mt-8">Update</h1>
      <p className="text-xl mt-5">
