const PrivacyPolicy = () => {
  return (
    <div className="pt-20 min-h-screen wrap-break-word">
      <h1 className="text-3xl font-bold">Privacy Policy for HotTopicsHub</h1>
      <p className="text-xl mt-5">
        At HotTopicsHub, accessible from https://hot-topics.vercel.app/, one of
        ...
        HotTopicsHub and how we use it.
      </p>
      ...
      <h1 className="text-3xl font-bold mt-8">Log Files</h1>
      <p className="text-xl mt-5">
      ...
      <h1 className="text-3xl font-bold mt-8">Our Advertising Partners</h1>
      <p className="text-xl mt-5">
      ...
      <h1 className="text-3xl font-bold mt-8">Privacy Policies</h1>
      <p className="text-xl mt-5">
        ...
        websites that you visit. Note that HotTopicsHub has no access to or
      ...
      <p className="text-xl mt-5">
        ...
        HotTopicsHub does not knowingly collect any Personal Identifiable
      ...
      <h1 className="text-3xl font-bold mt-8">Online Privacy Policy Only</h1>
      <p className="text-xl mt-5">
        This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they
        shared and/or collect in HotTopicsHub. This policy is not applicable to
        any information collected offline or via channels other than this
        website.
      </p>

      <h1 className="text-3xl font-bold mt-8">Consent</h1>
      <p className="text-xl mt-5">
